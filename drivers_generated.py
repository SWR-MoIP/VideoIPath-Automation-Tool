...
class CustomSettings_com_nevion_NMOS_0_1_0(DriverCustomSettings):
	...
	experimental_alarm_port: Optional[int] = Field(default=0, ge=0, le=65535, alias="com.nevion.NMOS.experimental_alarm_port")
	"""
...
class CustomSettings_com_nevion_NMOS_multidevice_0_1_0(DriverCustomSettings):
	...
	enable_experimental_alarm: bool = Field(default=False, alias="com.nevion.NMOS_multidevice.enable_experimental_alarm")
	"""
	Enable experimental alarms using IS-07\n
	Enables experimental alarms over websockets using IS-07 on certain Vizrt devices. Disables alarms completely if disabled
	"""

	experimental_alarm_port: Optional[int] = Field(default=0, ge=0, le=65535, alias="com.nevion.NMOS_multidevice.experimental_alarm_port")
	"""
	Experimental alarm port\n
	HTTP port for location of experimental IS-07 alarm websocket. If empty or 0 it uses Port field instead
	"""
...
class CustomSettings_com_nevion_archwave_unet_0_1_0(DriverCustomSettings):
	...
	channel_mode: Literal["Dual Mono", "Stereo"] = Field(default="Stereo", alias="com.nevion.archwave_unet.channel_mode")
	"""
...
class CustomSettings_com_nevion_cisco_nexus_0_1_0(DriverCustomSettings):
	...
	periodic_netconf_restart: int = Field(default=0, ge=0, le=2147483647, alias="com.nevion.nexus.periodic_netconf_restart")
	"""
...
class CustomSettings_com_nevion_emerge_openflow_0_0_1(DriverCustomSettings):
	...
	openflow_interface_shutdown_alarms: bool = Field(default=False, alias="com.nevion.openflow_interface_shutdown_alarms")
	"""
...
class CustomSettings_com_nevion_mock_0_1_0(DriverCustomSettings):
	...
	num_dynamic_resource_modules: int = Field(default=0, ge=0, le=10, alias="com.nevion.mock.num_dynamic_resource_modules")
	"""
	#DynamicResourceMods\n
...
class CustomSettings_com_nevion_selenio_13p_0_1_0(DriverCustomSettings):
	...
	cache_alarm_config_timeout: int = Field(default=1800, ge=0, le=252635728, alias="com.nevion.selenio_13p.cache_alarm_config_timeout")
	"""
...
class CustomSettings_com_nevion_sony_nxlk_ip50y_0_1_0(DriverCustomSettings):
	...
	experimental_alarm_port: Optional[int] = Field(default=0, ge=0, le=65535, alias="com.nevion.sony_nxlk-ip50y.experimental_alarm_port")
	"""
	Experimental alarm port\n
	HTTP port for location of experimental IS-07 alarm websocket. If empty or 0 it uses Port field instead
	"""
...
class CustomSettings_com_nevion_sony_nxlk_ip51y_0_1_0(DriverCustomSettings):
	...
	experimental_alarm_port: Optional[int] = Field(default=0, ge=0, le=65535, alias="com.nevion.sony_nxlk-ip51y.experimental_alarm_port")
	"""
	Experimental alarm port\n
	HTTP port for location of experimental IS-07 alarm websocket. If empty or 0 it uses Port field instead
	"""
...
class CustomSettings_com_nevion_tvg480_0_1_0(DriverCustomSettings):
	...
	control_mode: Literal["full_control", "partial_control_with_config_restore"] = Field(default="full_control", alias="com.nevion.tvg480.control_mode")
	"""
	Control Mode\n
	...
	partial_control_config_slot: int = Field(default=0, ge=0, le=7, alias="com.nevion.tvg480.partial_control_config_slot")
	"""
...
class CustomSettings_com_sony_MLS_X1_1_0(DriverCustomSettings):
	...
	tallyType: Literal["NOT_USE_TALLY", "TALLY_MASTER_DEVICE", "TALLY_DISPLAY_DEVICE", "MASTER_AND_DISPLAY_DEVICE"] = Field(default="NOT_USE_TALLY", alias="com.nevion.nsbus.tallyType")
	"""
	NS-BUS Tally Type\n
