...
from videoipath_automation_tool.apps.inventory.version_2023_4_2.create_device import InventoryCreateDeviceMixin
from videoipath_automation_tool.apps.inventory.version_2023_4_2.create_device_from_discovered_device import (
    InventoryCreateDeviceFromDiscoveredDeviceMixin,
)
from videoipath_automation_tool.apps.inventory.version_2023_4_2.get_device import InventoryGetDeviceMixin
from videoipath_automation_tool.apps.inventory.version_2023_4_2.inventory_api import InventoryAPI
from videoipath_automation_tool.apps.inventory.version_2023_4_2.model.drivers import (
    CustomSettings,
    CustomSettingsType,
    DriverLiteral,
)
from videoipath_automation_tool.apps.inventory.version_2023_4_2.model.inventory_device import InventoryDevice
from videoipath_automation_tool.apps.inventory.version_2023_4_2.model.inventory_device_configuration_compare import (
    InventoryDeviceComparison,
)
from videoipath_automation_tool.apps.inventory.version_2023_4_2.model.inventory_discovered_device import (
...
class InventoryApp(InventoryCreateDeviceMixin, InventoryCreateDeviceFromDiscoveredDeviceMixin, InventoryGetDeviceMixin):
    version: Literal["2023.4.2"] = "2023.4.2"
