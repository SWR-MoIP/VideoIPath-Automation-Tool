...
from videoipath_automation_tool.apps.inventory.version_2024_1_4.model.drivers import CustomSettingsType
from videoipath_automation_tool.apps.inventory.version_2024_1_4.model.inventory_device_configuration import (
    Auth,
    DeviceConfiguration,
    DriverInfos,
)
