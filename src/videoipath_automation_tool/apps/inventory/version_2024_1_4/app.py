...
from videoipath_automation_tool.apps.inventory.version_2024_1_4.create_device import InventoryCreateDeviceMixin
from videoipath_automation_tool.apps.inventory.version_2024_1_4.create_device_from_discovered_device import (
    InventoryCreateDeviceFromDiscoveredDeviceMixin,
)
from videoipath_automation_tool.apps.inventory.version_2024_1_4.get_device import InventoryGetDeviceMixin
from videoipath_automation_tool.apps.inventory.version_2024_1_4.inventory_api import InventoryAPI
from videoipath_automation_tool.apps.inventory.version_2024_1_4.model.drivers import (
    CustomSettings,
    CustomSettingsType,
    DriverLiteral,
)
from videoipath_automation_tool.apps.inventory.version_2024_1_4.model.inventory_device import InventoryDevice
from videoipath_automation_tool.apps.inventory.version_2024_1_4.model.inventory_device_configuration_compare import (
    InventoryDeviceComparison,
)
from videoipath_automation_tool.apps.inventory.version_2024_1_4.model.inventory_discovered_device import (
...
class InventoryApp(InventoryCreateDeviceMixin, InventoryCreateDeviceFromDiscoveredDeviceMixin, InventoryGetDeviceMixin):
    version: Literal["2024.1.4"] = "2024.1.4"
