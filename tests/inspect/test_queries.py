...
def test_all_queries_within_length_limit():
...
def test_device_skeleton_suppresses_modules_and_selects_skeleton_fields():
...
def test_query_too_long_raises(monkeypatch):
